const { lobbies } = require("../models/hashTable.js")
...
*/
    ...
    if (lobby.hostPlayer.username == secondUsername) {
        res.status(409).json({ errorMessage: "That username has been taken by another player in the lobby "})
    }
    else { 
